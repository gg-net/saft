    ...
    public static class SaftSwingApplication extends Application {
        ...
        public void start(Stage stage) throws Exception {
            UiCore.continueJavaFx(UiUtil.startup(stage, () -> {
                ...
                p.getButtonOne().setOnAction(e -> Ui.build(p).fx().show(() -> new WindowWithDirectClose()));
                p.getButtonTwo().setOnAction(e -> Ui.build(p).fx().show(() -> new WindowWithCloseBinding()));
